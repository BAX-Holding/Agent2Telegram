...
class Config:
    ...
    stt_language_code: str = ""          # optional ISO-639-1/3 hint, e.g. "sk"
    ...
    def validate(self) -> None:
        ...
        if not isinstance(self.stt_language_code, str):
            raise ConfigError("'stt_language_code' must be a string.")
        self.stt_language_code = self.stt_language_code.strip()
